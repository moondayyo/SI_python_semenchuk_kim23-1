...
# Define a multilayer neural network with 2 hidden layers; the first hidden layer has 6 neurons and the second one has 1 neuron
nn = nl.net.newff([[min_value, max_value]], [6, 1, 1])
